...
function SoundCloudIcon() {
  return (
    <svg className={styles.icon} viewBox="0 0 24 24" fill="currentColor">
      <path d="M11.562 13.922c0 .4-.008.79-.026 1.18a3.33 3.33 0 0 1-.098 1.042 3.82 3.82 0 0 1-.192.95 4.31 4.31 0 0 1-.286.862 5.03 5.03 0 0 1-.363.754c-.132.228-.276.438-.43.626s-.318.348-.49.486c-.17.135-.353.245-.544.333a2.91 2.91 0 0 1-.587.194c-.197.042-.4.07-.607.08-.204.01-.41.018-.614.018H1.325v-10.43c.478 0 .937.1 1.368.303.414.195.776.468 1.077.81.285.322.497.712.632 1.157.132.428.2 1.01.2 1.74zM24 16.32c0 .138-.01.275-.03.41-.132.032-.27.048-.415.048h-9.704c-.015-.399-.023-.799-.023-1.196s.01-1.072.03-1.46c.03-.54.103-1.05.215-1.52.112-.475.27-.905.47-1.29.21-.383.456-.713.738-.988.29-.276.623-.497.994-.664.383-.173.804-.26 1.263-.26.24 0 .47.026.69.076.222.052.43.127.625.226.2.098.386.216.556.353.176.138.334.298.473.473.14.175.264.368.373.576.108.204.2.42.274.646.073.22.13.45.168.685l.033.22s.225-.262.47-.46c.26-.21.564-.383.914-.525.35-.142.748-.214 1.193-.214.542 0 1.033.106 1.474.316.44.208.82.51 1.144.9.324.39.57.86.738 1.41.173.553.26 1.17.26 1.854z" />
    </svg>
  );
}
